                             ...
                             int &sparse_size)
{
  ...
  switch (grid_type) {
    case OPENVDB_GRID_BOOL:
      return image_load_preprocess<BoolGrid, unsigned __int64>(
                        ...
                        float *image)
{
  ...
  if (make_sparse && use_pad) {
    switch (grid_type) {
      case OPENVDB_GRID_BOOL:
        return image_load_sparse_pad<BoolGrid, unsigned __int64>(
    ...
    switch (grid_type) {
      case OPENVDB_GRID_BOOL:
        return image_load_sparse<BoolGrid, unsigned __int64>(
    ...
    switch (grid_type) {
      case OPENVDB_GRID_BOOL:
        return image_load_dense<BoolGrid, unsigned __int64>(grid, resolution, min_bound, 1, image);
      case OPENVDB_GRID_DOUBLE:
